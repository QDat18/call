                    ...
                    @forelse($calls ?? [] as $call)
                        ...
                        <div class="call-item {{ $isMissed ? 'missed' : '' }}" data-call-id="{{ $call->call_id }}">
                            ...
                            <div class="call-info">
                                ...
                                <div class="call-meta">
                                    <i class="fas fa-arrow-{{ $isOutgoing ? 'right' : 'left' }} me-1 {{ $isOutgoing ? 'text-success' : 'text-info' }}"></i>
                            ...
                            <div class="call-actions">
                                <button 
                                    ...
                                    onclick="startCall({{ $otherUser->user_id }}, 'video')"
                                    title="Video Call">
                                    <i class="fas fa-video"></i>
                                </button>
                                <button 
                                    class="btn-action btn-audio" 
                                    onclick="startCall({{ $otherUser->user_id }}, 'audio')"
                                    title="Audio Call">

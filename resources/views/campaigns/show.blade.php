            ...
            <div class="max-w-7xl mx-auto px-6 pb-16 w-full">
                <div class="max-w-4xl">
                    ...
                    @if($campaign->end_date > now() && $campaign->status == 'Active')
                        <span class="inline-flex items-center gap-2 bg-emerald-500/90 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-semibold mb-4 shadow-lg">
                    ...
                    @else
                        <span class="inline-flex items-center gap-2 bg-gray-500/90 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-semibold mb-4 shadow-lg">
        ...
        <div class="max-w-7xl mx-auto px-6 py-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-4">
                ...
                <div class="text-center md:text-left">
                    ...
                    <p class="text-3xl font-bold text-orange-600">{{ $days_left }}</p>
                        ...
                        @forelse($recentDonations as $donation)
                            <div class="flex items-start gap-4 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    @if($donation->message)
                                        <p class="text-gray-600 text-sm mb-2 italic bg-white p-3 rounded-lg border-l-4 border-blue-300">
                                            "{{ $donation->message }}"
                                        </p>
                                    @endif

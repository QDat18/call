...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-1">Add a new opportunity category</p>
        </div>
    ...
    <!-- Form -->
    <form id="createCategoryForm" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        @csrf
        ...
        <div class="mb-6">
            ...
            <p class="text-xs text-gray-500 mt-1">Must be unique and descriptive</p>
        </div>
        ...
        <div class="grid grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <input type="text" id="colorText" value="#6366f1" readonly
        ...
        <div class="mb-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div class="flex items-center space-x-4">
                <div id="iconPreview" class="w-16 h-16 rounded-lg flex items-center justify-center"
                    ...
                    <i class="fas fa-tag text-3xl" style="color: #6366f1"></i>
                </div>
                <div>
                    <h3 id="namePreview" class="font-semibold text-gray-900">Category Name</h3>
                    <p id="descPreview" class="text-sm text-gray-600">Description will appear here</p>
                </div>
            </div>
        </div>
...
document.querySelector('[name="description"]').addEventListener('input', function(e) {
    document.getElementById('descPreview').textContent = e.target.value || 'Description will appear here';
});

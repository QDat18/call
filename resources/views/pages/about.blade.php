        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 mb-16">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                    <div>
                        <div class="text-3xl md:text-4xl font-bold text-indigo-600 dark:text-indigo-400 mb-2"
                            id="volunteerCount">0</div>
            ...
            <div class="mb-16">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="text-center">
                        <div
                            class="w-20 h-20 bg-red-100 dark:bg-red-900 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="text-center">
                        <div
                            class="w-32 h-32 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-4xl font-bold">
                            HSQ
                        </div>
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Hoàng Quang Đạt</h3>
                        <p class="text-indigo-600 dark:text-indigo-400 mb-2">Leader + Admin Module</p>
                    ...
                    <div class="text-center">
                        <div
                            class="w-32 h-32 bg-gradient-to-br from-green-400 to-blue-500 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-4xl font-bold">
                            MT
                        </div>
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Nguyễn Mạnh Thắng</h3>
                        <p class="text-indigo-600 dark:text-indigo-400 mb-2">Organization + Word</p>
                        <p class="text-gray-600 dark:text-gray-300 text-sm">
                    ...
                    <div class="text-center">
                        <div
                            class="w-32 h-32 bg-gradient-to-br from-purple-400 to-pink-500 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-4xl font-bold">
                            QD
                        </div>
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Nguyễn Quang Duy</h3>
                        <p class="text-indigo-600 dark:text-indigo-400 mb-2">Authencicate Module</p>
                        <p class="text-gray-600 dark:text-gray-300 text-sm">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Đặng Trường Duy/h3>
                        <p class="text-indigo-600 dark:text-indigo-400 mb-2">Volunteer Module</p>
                        <p class="text-gray-600 dark:text-gray-300 text-sm">
                            Với 10 năm kinh nghiệm trong lĩnh vực tổ chức các hoạt động tình nguyện quy mô lớn.
                        </p>
                    </div>
                    <div class="text-center">
                        <div
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Hoàng Gia Khiêm</h3>
                        <p class="text-indigo-600 dark:text-indigo-400 mb-2">Connections Module</p>
                        <p class="text-gray-600 dark:text-gray-300 text-sm">
                            Với 3 năm kinh nghiệm kết nối cộng đồng tình nguyện.
                        </p>
                    </div>
                </div>
            </div>

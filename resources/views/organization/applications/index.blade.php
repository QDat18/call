                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            {{-- FIX: Avatar Logic tại đây --}}
                                            @php
                                                $avatarIndex = $application->volunteer->avatar_url
                                                    ? asset('storage/' . $application->volunteer->avatar_url)
                                                    : 'https://ui-avatars.com/api/?name=' . urlencode($application->volunteer->first_name . ' ' . $application->volunteer->last_name) . '&background=random';
                                            @endphp
                                            <img src="{{ $avatarIndex }}" alt="{{ $application->volunteer->first_name }}"

                ...
                <div class="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-800">
                            ...
                            <span class="text-sm text-gray-500">({{ $application->applied_date->diffForHumans() }})</span>
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-800">{{ $application->interview_scheduled->format('M d, Y H:i') }}</p>
                    </div>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-800">{{ $application->volunteer->volunteerProfile->occupation }}</p>
                    </div>
                    @endif
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-800">{{ $application->volunteer->volunteerProfile->education_level }}</p>
                    </div>
                    @endif
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            @foreach(explode(',', $application->volunteer->volunteerProfile->skills) as $skill)
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-800">{{ $application->volunteer->volunteerProfile->availability }}</p>
                    </div>
                    @endif

                    <div>
                        <p class="text-sm text-gray-600">Volunteer Hours</p>
                        <p class="font-medium text-gray-800">{{ $application->volunteer->volunteerProfile->total_volunteer_hours ?? 0 }} hours</p>
                    </div>

                    <div>
                        <p class="text-sm text-gray-600">Rating</p>
                        <div class="flex items-center gap-2">
                            <span class="font-medium text-gray-800">{{ number_format($application->volunteer->volunteerProfile->volunteer_rating ?? 0, 1) }}</span>
                            <div class="flex">
                                @for($i = 1; $i <= 5; $i++)
                                <svg class="w-4 h-4 {{ $i <= ($application->volunteer->volunteerProfile->volunteer_rating ?? 0) ? 'text-yellow-400' : 'text-gray-300' }}" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">{{ $application->interview_scheduled->format('M d, Y H:i') }}</p>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="flex gap-3">
                        <div class="flex-shrink-0">
                            <div class="w-8 h-8 {{ $application->status == 'Accepted' ? 'bg-green-100' : 'bg-red-100' }} rounded-full flex items-center justify-center">
                                <svg class="w-4 h-4 {{ $application->status == 'Accepted' ? 'text-green-600' : 'text-red-600' }}" fill="currentColor" viewBox="0 0 20 20">

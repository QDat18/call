...
@section('content')
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="font-medium text-gray-800">
                                    {{ $opportunity->experience_needed ?? 'No experience' }}</p>
                            </div>
                        </div>
                        ...
                        @if($opportunity->application_deadline)
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="font-medium text-gray-800">
                                        {{ date('M d, Y', strtotime($opportunity->application_deadline)) }}</p>
                                </div>
                            </div>
                        @endif
                    </div>
    ...
    <div id="deleteModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
        <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <p class="text-gray-600 mb-6">Are you sure you want to delete this opportunity? This action cannot be undone.
            </p>
            <div class="flex gap-3">
                ...
                <form action="{{ route('organization.opportunities.destroy', $opportunity->opportunity_id) }}" method="POST"
                    class="flex-1">
                    @csrf
                    @method('DELETE')
                    <button type="submit"

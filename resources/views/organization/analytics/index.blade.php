    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-sm bg-white/20 px-3 py-1 rounded-full" x-text="stats.opportunities_growth + '%'"></span>
            </div>
            <h3 class="text-3xl font-bold mb-1" x-text="stats.total_opportunities"></h3>
            <p class="text-blue-100 text-sm">Total Opportunities</p>
            <div class="mt-3 flex items-center gap-2 text-sm">
                <span x-text="stats.active_opportunities"></span>
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-sm bg-white/20 px-3 py-1 rounded-full" x-text="stats.applications_growth + '%'"></span>
            </div>
            <h3 class="text-3xl font-bold mb-1" x-text="stats.total_applications"></h3>
            <p class="text-green-100 text-sm">Total Applications</p>
            <div class="mt-3 flex items-center gap-2 text-sm">
                <span x-text="stats.pending_applications"></span>
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-6 text-white">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-sm bg-white/20 px-3 py-1 rounded-full" x-text="stats.volunteers_growth + '%'"></span>
            </div>
            <h3 class="text-3xl font-bold mb-1" x-text="stats.active_volunteers"></h3>
            <p class="text-purple-100 text-sm">Active Volunteers</p>
            <div class="mt-3 flex items-center gap-2 text-sm">
                <span x-text="stats.new_volunteers"></span>
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-6 text-white">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-sm bg-white/20 px-3 py-1 rounded-full" x-text="stats.hours_growth + '%'"></span>
            </div>
            <h3 class="text-3xl font-bold mb-1" x-text="formatNumber(stats.total_hours)"></h3>
            <p class="text-orange-100 text-sm">Volunteer Hours</p>
            <div class="mt-3 flex items-center gap-2 text-sm">
                <span x-text="stats.verified_hours"></span>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex gap-2">
                    <button @click="chartType = 'line'" :class="chartType === 'line' ? 'bg-green-600 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300'" 
                        class="px-3 py-1 rounded text-sm">Line</button>
                    <button @click="chartType = 'bar'" :class="chartType === 'bar' ? 'bg-green-600 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300'" 
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="grid grid-cols-2 gap-4 mt-6">
                <div class="text-center">
                    <p class="text-2xl font-bold text-yellow-600" x-text="stats.pending_applications"></p>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Pending</p>
                </div>
                <div class="text-center">
                    <p class="text-2xl font-bold text-green-600" x-text="stats.accepted_applications"></p>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Accepted</p>
                </div>
                <div class="text-center">
                    <p class="text-2xl font-bold text-red-600" x-text="stats.rejected_applications"></p>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Rejected</p>
                </div>
                <div class="text-center">
                    <p class="text-2xl font-bold text-gray-600" x-text="stats.withdrawn_applications"></p>
            ...
            <div class="space-y-4">
                <template x-for="(opp, index) in topOpportunities" :key="index">
                    <div class="flex items-center gap-4">
                        <div class="w-8 h-8 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center text-green-600 dark:text-green-400 font-semibold text-sm" x-text="index + 1"></div>
                        <div class="flex-1">
                            <p class="font-medium text-gray-900 dark:text-white" x-text="opp.title"></p>
            ...
            <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div class="relative inline-flex items-center justify-center w-24 h-24 mb-3">
                    <svg class="transform -rotate-90 w-24 h-24">
                        <circle cx="48" cy="48" r="40" stroke="currentColor" stroke-width="8" fill="transparent" class="text-gray-300 dark:text-gray-600"/>
                        <circle cx="48" cy="48" r="40" stroke="currentColor" stroke-width="8" fill="transparent" 
                            :stroke-dasharray="251.2" 
                            :stroke-dashoffset="251.2 - (251.2 * stats.acceptance_rate / 100)"
                            class="text-green-600 transition-all duration-1000"/>
                    </svg>
                    <span class="absolute text-xl font-bold text-gray-900 dark:text-white" x-text="stats.acceptance_rate + '%'"></span>
                </div>
            ...
            <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div class="relative inline-flex items-center justify-center w-24 h-24 mb-3">
                    <svg class="transform -rotate-90 w-24 h-24">
                        ...
                        <circle cx="48" cy="48" r="40" stroke="currentColor" stroke-width="8" fill="transparent" 
                            :stroke-dasharray="251.2" 
                            :stroke-dashoffset="251.2 - (251.2 * (stats.avg_response_time / 10))"
                            class="text-blue-600 transition-all duration-1000"/>
                    </svg>
                    <span class="absolute text-xl font-bold text-gray-900 dark:text-white" x-text="stats.avg_response_time"></span>
                </div>
            ...
            <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div class="relative inline-flex items-center justify-center w-24 h-24 mb-3">
                    <svg class="transform -rotate-90 w-24 h-24">
                        ...
                        <circle cx="48" cy="48" r="40" stroke="currentColor" stroke-width="8" fill="transparent" 
                            :stroke-dasharray="251.2" 
                            :stroke-dashoffset="251.2 - (251.2 * stats.completion_rate / 100)"
                            class="text-purple-600 transition-all duration-1000"/>
                    </svg>
                    <span class="absolute text-xl font-bold text-gray-900 dark:text-white" x-text="stats.completion_rate + '%'"></span>
                </div>
            ...
            <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div class="relative inline-flex items-center justify-center w-24 h-24 mb-3">
                    <svg class="transform -rotate-90 w-24 h-24">
                        ...
                        <circle cx="48" cy="48" r="40" stroke="currentColor" stroke-width="8" fill="transparent" 
                            :stroke-dasharray="251.2" 
                            :stroke-dashoffset="251.2 - (251.2 * stats.retention_rate / 100)"
                            class="text-orange-600 transition-all duration-1000"/>
                    </svg>
                    <span class="absolute text-xl font-bold text-gray-900 dark:text-white" x-text="stats.retention_rate + '%'"></span>
                </div>
...
function analyticsData() {
    return {
        ...
        async loadData() {
            try {
                const response = await fetch(`/organization/analytics/data?range=${this.dateRange}`);
            ...
            if (ctx2) {
                this.charts.status = new Chart(ctx2, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [
                                this.stats.pending_applications,
                                this.stats.accepted_applications,
                                this.stats.rejected_applications,
                                this.stats.withdrawn_applications
                            ],
                            backgroundColor: [
                                'rgb(234, 179, 8)',
                                'rgb(34, 197, 94)',
        ...
        exportReport() {
            window.location.href = `/organization/analytics/export?range=${this.dateRange}`;
        }
    }
}
</script>

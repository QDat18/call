        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
            ...
            <div class="relative px-8 pb-8">
                ...
                <div class="absolute -top-16 left-8">
                    <div
                        class="w-32 h-32 rounded-xl bg-white dark:bg-gray-700 border-4 border-white dark:border-gray-800 shadow-xl flex items-center justify-center overflow-hidden">
                        @if($organization->user->avatar_url)
                            <img src="{{ asset('storage/avatars/organizations/' . basename($organization->user->avatar_url)) }}"
                        alt="Logo" class="w-full h-full object-cover"> @else
                ...
                <div class="mt-4 space-y-2">
                    <div class="flex items-center space-x-3">
                        ...
                        @if($organization->verification_status === 'Verified')
                            <div
                                class="flex items-center space-x-1 bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 px-3 py-1 rounded-full">
                                <i class="fas fa-check-circle"></i>
                                <span class="text-sm font-semibold">Verified</span>
                            </div>
                        @elseif($organization->verification_status === 'Pending')
                            <div
                                class="flex items-center space-x-1 bg-yellow-100 dark:bg-yellow-900 text-yellow-600 dark:text-yellow-300 px-3 py-1 rounded-full">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                @if($organization->mission_statement)
                    <div
                        class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl shadow p-6 border-l-4 border-green-600">
                        <h2 class="text-xl font-bold text-gray-800 dark:text-white mb-4 flex items-center">
            ...
            <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            <div>
                                ...
                                <p class="text-sm font-mono text-gray-700 dark:text-gray-300">
                                    {{ $organization->registration_number }}</p>
                            </div>
                            <div class="mt-3">
                ...
                @if($organization->verification_status !== 'Verified')
                    <div
                        class="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl shadow p-6 border border-blue-200 dark:border-blue-800">
